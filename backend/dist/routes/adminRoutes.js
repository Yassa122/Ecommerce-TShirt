...
adminRoutes.get('/orders', adminController_1.getAllOrders);
adminRoutes.put('/editProduct/:id', adminController_1.editProduct);
adminRoutes.post('/addPhoto', adminController_1.addPhoto);
adminRoutes.delete('/deletePhoto/:id', adminController_1.deletePhoto);
adminRoutes.get("/getAllPhotos", adminController_1.getAllPhotos);
